...
// This component allows users to report flood incidents and view recent reports.
// Features include:
// - Form submission for new flood reports with image uploads.
// - Automatic or manual location selection.
// - Filtering and displaying recent reports.
    ...
    navigator.geolocation.getCurrentPosition(
      async (position) => {
        ...
        try {
          ...
          const detected = address.village || address.town || address.city || address.suburb || address.county || data.display_name;
          const locationValue = detected.replace(/\s+/g, '-').toLowerCase();
          setSelectedLocation({ value: locationValue, label: detected });
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-blue-100 border border-blue-200 p-4 rounded-lg flex items-center gap-3">
          ...
          <p className="text-sm text-blue-800">
            After submitting your report, it will be reviewed by our team. Once verified, your report will appear on the dashboard.
          </p>
        </motion.div>
                ...
                <div className="overflow-y-auto h-[calc(100vh-260px)] space-y-4 p-4">
                  ...
                  {filteredRecentReports.length === 0 && (
                    <div className="flex flex-col items-center justify-center h-full py-8 text-center">
                      ...
                      <h3 className="font-medium">No flood reports found matching your search</h3>
                    </div>
                  )}
                </div>
              </CardContent>
