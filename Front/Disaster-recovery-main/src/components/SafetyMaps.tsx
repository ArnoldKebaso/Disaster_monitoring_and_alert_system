...
const SafetyMaps: React.FC = () => {
  ...
  const createAlertPopupContent = (alert: FloodAlert) => `
    <div class="popup-content">
      ...
      <p class="text-sm"><strong>Severity:</strong> <span class="text-${getSeverityColor(
        alert.severity
    ...
    try {
      ...
      route.forEach((point, index) => {
        L.marker(point, { icon: routeIcon })
          .addTo(markerLayer)
          .bindPopup(
            `<div class="p-2"><strong>Step ${index + 1}</strong><br>${getRouteInstruction(
              index
            )}</div>`
          );
      });
      ...
      L.marker(
        ...
        .addTo(markerLayer)
        .bindPopup(
          `<strong>${alert.location} Shelter</strong><br>Capacity: 500 people`
        );
          ...
          action: {
            ...
            onClick: () => {
              ...
              if (isChrome) {
                ...
                window.open(
                  "https://support.google.com/chrome/answer/114662?co=GENIE.Platform%3DDesktop"
                );
              }
            },
          },
    ...
    try {
      ...
      if (data.length > 0) {
        ...
        L.marker([lat, lon], {
          ...
          .addTo(markerLayer)
          .bindPopup(`<strong>Searched Location: ${searchQuery}</strong>`);
      } else {
        ...
        <div className="mb-6 bg-white p-4 rounded-lg shadow-sm">
          <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-2">
            <Input
              ...
              className="flex-grow border-2 border-gray-200 focus:border-blue-500 rounded"
            />
          ...
          <Card className="h-[600px] overflow-y-auto">
            <CardContent className="p-4">
              ...
              <div className="mt-6 pt-4 border-t border-gray-200">
                ...
                <Button variant="outline" className="w-full mb-2" onClick={() => navigate('/report')}>
