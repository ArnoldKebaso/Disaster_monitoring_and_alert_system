...
// Importing Lucide React icons for visual elements
import {
  Droplet,
  ShieldAlert,
  Globe,
...
/**
 * AboutUs Component - Displays the about us page with company information, features, and impact stats.
 * Uses Framer Motion for animations and react-i18next for internationalization.
 */
const AboutUs: React.FC = () => {
  ...
  // Array of icons for the features section
  // Note: We can't include React components in translation files, so we define icons locally
  const featureIcons = [
    AlertCircle,
    RadioTower,
    BookOpen,
  ...
  // Get translated features array from i18n (contains title and content for each feature)
  const features = t("about.features.items", { returnObjects: true }) as {
    title: string;
    content: string;
  }[];

  // Get translated impact statistics from i18n
